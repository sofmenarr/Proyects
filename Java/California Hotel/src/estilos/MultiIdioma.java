...
public class MultiIdioma {
	...
	public static String IdiomaBoton(String boton) {
		...
		case 1:
			...
			// BOTONES DE LA VENTANA ACTIVIDADES
			if (boton.equalsIgnoreCase("Abrir")) {
				textoBoton = "Abrir";
			}
			break;
		case 2:
	...
	public static String IdiomaTexto(String tipo) {
		...
		case 1:
			...
			if (tipo.equalsIgnoreCase("TituloActividades")) {
				texto = "<html><center>Información<br>Actividades</center><html>";
			}
			if (tipo.equalsIgnoreCase("EncabezadoActividades")) {
				texto = "ACTIVIDADES PARA REALIZAR:";
			}
			if (tipo.equalsIgnoreCase("TituloActividad1")) {
				texto = "Bono Bienestar";
			}
			if (tipo.equalsIgnoreCase("TextoActividad1")) {
				texto = "<html>El lujo de desconectar para conectar. "
						+ "Invitamos en exclusiva a nuestros clientes a explorar " + "nuestra Wellbeing Area.<html>";
			}
			if (tipo.equalsIgnoreCase("TituloActividad2")) {
				texto = "Yoga";
			}
			if (tipo.equalsIgnoreCase("TextoActividad2")) {
				texto = "<html>Encuentra la mejor versión de ti. " + "Sesiones gratuitas de Yoga para clientes "
						+ "alojados en el hotel.<html>";
			}
			if (tipo.equalsIgnoreCase("TituloActividad3")) {
				texto = "Taller de Coctelería";
			}
			if (tipo.equalsIgnoreCase("TextoActividad3")) {
				texto = "<html>Descubra nuevos sabores. "
						+ "Nuestro barman enseñará a preparar "
						+ "cócteles clásicos.<html>";
			}
			if (tipo.equalsIgnoreCase("TituloActividad4")) {
				texto = "Cine al Aire Libre";
			}
			if (tipo.equalsIgnoreCase("TextoActividad4")) {
				texto = "<html>Películas bajo las estrellas. Vive una experiencia cinematográfica "
						+ "única con nuestras proyecciones al aire libre.<html>";
			}
			if (tipo.equalsIgnoreCase("TituloActividad5")) {
				texto = "Cata de Vinos";
			}
			if (tipo.equalsIgnoreCase("TextoActividad5")) {
				texto = "<html>Una experiencia enológica exclusiva. Cata de vinos "
						+ "seleccionados de las mejores bodegas de la región.<html>";
			}
			if (tipo.equalsIgnoreCase("TituloActividad6")) {
				texto = "Conserjería";
			}
			if (tipo.equalsIgnoreCase("TextoActividad6")) {
				texto = "<html>Un equipo a su disposición. "
						+ "Conozca Madrid como un auténtico local.<html>";
			}
			if (tipo.equalsIgnoreCase("EncabezadoTransporte")) {
				texto = "TRANSPORTE PUBLICO:";
			}
			if (tipo.equalsIgnoreCase("EncBus")) {
				texto = "Autobús";
			}
			if (tipo.equalsIgnoreCase("TextoBus")) {
				texto = "<html>719, 726, 543,<br> 544, 545, 546<html>";
			}
			if (tipo.equalsIgnoreCase("EncMetro")) {
				texto = "Metro";
			}
			if (tipo.equalsIgnoreCase("TextoMetro")) {
				texto = "Líneas 3, 6 y 9";
			}
			if (tipo.equalsIgnoreCase("EncTren")) {
				texto = "Tren";
			}
			if (tipo.equalsIgnoreCase("TextoTren")) {
				texto = "C4 y C7";
			}
		...
		case 2:
			...
			if (tipo.equalsIgnoreCase("TextoActividad1")) {
			    texto = "<html>The luxury of disconnecting to reconnect. "
			          + "We exclusively invite our guests to explore " 
			          + "our Wellbeing Area.<html>";
			}
			if (tipo.equalsIgnoreCase("TituloActividad2")) {
			    texto = "Yoga";
			}
			if (tipo.equalsIgnoreCase("TextoActividad2")) {
			    texto = "<html>Find the best version of yourself. "
			          + "Free yoga sessions for hotel guests.<html>";
			}
			if (tipo.equalsIgnoreCase("TituloActividad3")) {
			    texto = "Cocktail Workshop";
			}
			if (tipo.equalsIgnoreCase("TextoActividad3")) {
			    texto = "<html>Discover new flavors. "
			          + "Our bartender will teach you how to prepare "
			          + "classic cocktails.<html>";
			}
			if (tipo.equalsIgnoreCase("TituloActividad4")) {
			    texto = "Open-Air Cinema";
			}
			if (tipo.equalsIgnoreCase("TextoActividad4")) {
			    texto = "<html>Movies under the stars. Enjoy a unique cinematic "
			          + "experience with our outdoor screenings.<html>";
			}
			if (tipo.equalsIgnoreCase("TituloActividad5")) {
			    texto = "Wine Tasting";
			}
			if (tipo.equalsIgnoreCase("TextoActividad5")) {
			    texto = "<html>An exclusive wine experience. Taste wines "
			          + "selected from the best wineries in the region.<html>";
			}
			if (tipo.equalsIgnoreCase("TituloActividad6")) {
			    texto = "Concierge";
			}
			if (tipo.equalsIgnoreCase("TextoActividad6")) {
			    texto = "<html>A team at your service. "
			          + "Discover Madrid like a true local.<html>";
			}
			if (tipo.equalsIgnoreCase("EncabezadoTransporte")) {
			    texto = "PUBLIC TRANSPORT:";
			}
			if (tipo.equalsIgnoreCase("EncBus")) {
			    texto = "Bus";
			}
