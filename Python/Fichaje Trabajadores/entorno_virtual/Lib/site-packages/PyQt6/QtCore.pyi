...
class QChar(PyQt6.sip.simplewrapper):
    ...
    def __eq__(self, other: object): ...
    def __ne__(self, other: object): ...
    def __ge__(self, rhs: 'QChar') -> bool: ...
    def __le__(self, rhs: 'QChar') -> bool: ...
    def __gt__(self, rhs: 'QChar') -> bool: ...
    def __lt__(self, rhs: 'QChar') -> bool: ...
...
class QDataStream(QIODeviceBase):
    ...
    @typing.overload
    def __lshift__(self, a0: QChar) -> 'QDataStream': ...
    @typing.overload
...
class QTextStream(QIODeviceBase):
    ...
    def padChar(self) -> QChar: ...
    def setPadChar(self, ch: QChar) -> None: ...
...
class QUrlQuery(PyQt6.sip.simplewrapper):
    ...
    def __hash__(self) -> int: ...
    @staticmethod
    def defaultQueryPairDelimiter() -> QChar: ...
    @staticmethod
    def defaultQueryValueDelimiter() -> QChar: ...
    ...
    def queryPairDelimiter(self) -> QChar: ...
    def queryValueDelimiter(self) -> QChar: ...
...
def qSetPadChar(ch: QChar) -> QTextStreamManipulator: ...
